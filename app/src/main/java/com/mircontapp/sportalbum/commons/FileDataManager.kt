...
class FileDataManager() {
    companion object {
        fun writePlayers(context: Context, name: String?, players: List<PlayerModel?>) {
            ...
            players.forEach {
                list.add("${it?.name}_${it?.role}_${it?.gender}_${it?.team}_${it?.country}_${it?.birthyear}_${it?.value}_${it?.valueleg}_${it?.national}_${it?.nationalLegend}_${it?.roleLineUp}_${it?.att}_${it?.dif}_${it?.tec}_${it?.dri}_${it?.fin}_${it?.bal}_${it?.fis}_${it?.vel}_${it?.rig}_${it?.por}")
            }
