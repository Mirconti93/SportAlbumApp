...
class Enums {
    ...
    enum class PlayStyle(
        ...
        NORMAL(70, 70, 70, 70, 70, 70, 70, 70, 70, 70),
        FUORICLASSE(35, 35, 35, 35, 35, 35, 35, 35, 35, 25),
    ...
    enum class Evento {
        NONE, PALLEGGIO, PRESSING, ATTACCO, RECUPERO, RESPINTA, PARATA, AMMONIZIONE, DOPPIA_AMMONIZIONE, ESPULSIONE, RIGORE, PUNIZIONE, PUNIZIONE_DIRETTA, GOAL, GOAL_RIGORE
    }
