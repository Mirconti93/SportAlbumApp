...
class Enums {
    ...
    enum class Evento {
        NONE, PALLEGGIO, PRESSING, ATTACCO, RECUPERO, RESPINTA, PARATA, AMMONIZIONE, DOPPIA_AMMONIZIONE, ESPULSIONE, RIGORE, PUNIZIONE, PUNIZIONE_DIRETTA, GOAL, GOAL_RIGORE, GOAL_PUNIZIONE
    }
